    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('home.index') }}">{{ __('Home') }} <i class="ion-ios-arrow-forward"></i></a></span> <span>{{ __('rent') }} <i class="ion-ios-arrow-forward"></i></span></p>
            ...
            <div class="col-md-12	featured-top">
                <div class="row no-gutters">
                    <div class="col-md-4 d-flex align-items-center">
                        <form action="{{ route('home.rent.store') }}" class="request-form ftco-animate bg-primary" method="post">
                            @csrf
                    ...
                    <div class="col-md-8 d-flex align-items-center">
                        <div class="services-wrap rounded-right w-100">
                            ...
                            <p><a href="{{ route('home.cars') }}" class="btn btn-primary py-3 px-4">{{ __('Reserve Your Perfect Car') }}</a></p>
                        </div>
                    </div>
                </div>
            </div>
