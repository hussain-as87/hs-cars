            ...
            <div class="row d-flex mb-5 contact-info">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-12">
                            <div class="border w-100 p-4 rounded mb-2 d-flex">
                                ...
                                <p><span>{{ __('phone') }}:</span> <a
                                        href="tel://{{ config('settings.webiste_phone') }}">+ {{ config('settings.webiste_phone') }}</a>
                                </p>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="border w-100 p-4 rounded mb-2 d-flex">
                                ...
                                <p><span>{{ __('email') }}:</span> <a
                                        href="{{ config('settings.webiste_email') }}">{{ config('settings.webiste_email') }}</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-8 block-9 mb-md-5">
                    <form action="{{ route('home.contacts.store') }}" method="POST" class="bg-light p-5 contact-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="{{ __('enter your email') }}"
                        ...
                        <div class="form-group">
                            <textarea cols="30" rows="7" class="form-control" placeholder="{{ __('Message') }}"
