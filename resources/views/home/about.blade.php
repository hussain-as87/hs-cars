    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('home.index') }}">{{ __('Home') }} <i class="ion-ios-arrow-forward"></i></a></span> <span>{{ __('About Us') }} <i class="ion-ios-arrow-forward"></i></span></p>
                <h1 class="mb-3 bread">{{ __('About Us') }}</h1>
            </div>
        </div>
    </div>
</section>
...
<section class="ftco-section ftco-about">
    <div class="container">
        <div class="row no-gutters">
            <div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url({{ asset('storage/about/'.$about->photo) }});">
            </div>
            <div class="col-md-6 wrap-about ftco-animate">
                <div class="heading-section heading-section-white pl-md-5">
                    ...
                    <p><a href="#" class="btn btn-primary py-3 px-4">{{ __('Search Vehicle') }}</a></p>
                </div>
            </div>
        </div>
    </div>
