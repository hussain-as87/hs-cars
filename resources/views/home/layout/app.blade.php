    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item  {{ Request::segment(1) === null ? 'active' : '' }}"><a
                        href="{{ route('home.index') }}" class="nav-link">{{ __('Home') }}</a></li>
                <li class="nav-item {{ Request::segment(1) === 'about' ? 'active' : '' }}"><a
                        href="{{ route('home.about') }}" class="nav-link">{{ __('About') }}</a></li>
                <li class="nav-item {{ Request::segment(1) === 'services' ? 'active' : '' }}"><a
                        href="{{ route('home.services') }}" class="nav-link">{{ __('services') }}</a></li>
                <li class="nav-item {{ Request::segment(1) === 'pricing' ? 'active' : '' }}"><a
                        href="{{ route('home.pricing') }}" class="nav-link">{{ __('pricing') }}</a></li>
                <li class="nav-item {{ Request::segment(1) === 'cars' ? 'active' : '' }}"><a
                        href="{{ route('home.cars') }}" class="nav-link">{{ __('cars') }}</a></li>
                <li class="nav-item {{ Request::segment(1) === 'contact' ? 'active' : '' }}"><a
                        href="{{ route('home.contact') }}" class="nav-link">{{ __('Contact') }}</a></li>
...
<footer class="ftco-footer ftco-bg-dark ftco-section">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2"><a href="#" class="logo">{{ config('settings.website_name') }}
                            <span></span></a></h2>
                    <p>{{ __(config('settings.description')) }}</p>
                    <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                        <li class="ftco-animate"><a href="{{ config('settings.twitter_url')  }}"><span
                                    class="icon-twitter"></span></a></li>
                        <li class="ftco-animate"><a href="{{ config('settings.facebook_url')  }}"><span
                                    class="icon-facebook"></span></a></li>
                        <li class="ftco-animate"><a href="{{ config('settings.instagram_name')  }}"><span
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span> <span
                                    class="text"> {{ __(config('settings.address')) }}</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span> <span
                                        class="text"> {{ config('settings.webiste_phone') }}</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span> <span
                                        class="text"> {{ config('settings.webiste_email') }}</span></a></li>
                            <li>
                                <a href="#" id="languagesDropdown" data-toggle="dropdown" role="button"
                                   aria-expanded="false" aria-haspopup="true">
                                    <span
                                        class="icon icon-globe"></span>{{ __(config('locales.languages')[app()->getLocale()]['name']) }}
                                ...
                                <div class="dropdown-menu" aria-labelledby="languagesDropdown">
                                    @foreach(config('locales.languages') as $key => $val)
                                        @if ($key != app()->getLocale())
                                            <a style="color:black" href="{{ route('change.language', __($key)) }}"
        ...
        <div class="row"
             @if (config('locales.languages')[app()->getLocale()]['rtl_support'] == 'rtl') style="direction: rtl;"@endif>
            <div class="col-md-12 text-center">
                <p>
                    ...
                    </script> {{ __('All rights reserved | This template is made with') }} <i
                        class="icon-heart text-danger" aria-hidden="true"></i> {{ __('by') }} <a
                        href="https://github.com/hussein819" target="_blank"><span class="icon icon-github"></span>
                        hussein sim</a>
                    <!-- Link back to Colorlib cant be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
