        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" wire:click="reset_input()" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form wire:submit.prevent="store()">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="star1">
                                <input hidden wire:model="rating" type="radio" id="star1" value="1" />
                                <span class="@if($rating >= 1 ) text-warning @endif"><i class="ion-ios-star"></i></span>
                            </label>
                            <label for="star2">
                                <input hidden wire:model="rating" type="radio" id="star2" value="2" />
