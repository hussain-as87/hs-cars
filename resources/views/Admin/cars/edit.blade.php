                 ...
                 {!! old('description.' . $key, $car->getTranslation('description', $key)) ?? $car->description !!}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select id="transmission_type" name="transmission_type"
                            ...
                            <option
                                value="Manual transmission" {{ $car->transmission_type == 'Manual transmission' ? 'selected' : ''}}>{{ __('Manual transmission') }}</option>
                            <option
                                value="Automatic transmission" {{ $car->transmission_type == 'Automatic transmission' ? 'selected' : ''}}>{{ __('Automatic transmission') }}</option>
                            <option
                                value="Continuously variable transmission(CVT)" {{ $car->transmission_type == 'Continuously variable transmission (CVT)' ? 'selected' : ''}}>{{ __('Continuously variable transmission (CVT)') }}</option>
                            <option
                                value="Semi-automatic and dual-clutch transmissions" {{ $car->transmission_type == 'Semi-automatic and dual-clutch transmissions' ? 'selected' : ''}}>{{ __('Semi-automatic and dual-clutch transmissions') }}</option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select id="fuel" name="fuel"
                            ...
                            <option
                                value="Petrol" {{ $car->fuel == 'Petrol' ? 'selectd' : '' }}>{{ __('Petrol') }}</option>
                            <option
                                value="Diesel" {{ $car->fuel == 'Diesel' ? 'selectd' : '' }}>{{ __('Diesel') }}</option>
                            <option
                                value="Alternative Fuels" {{ $car->fuel == 'Alternative Fuels' ? 'selectd' : '' }}>{{ __('Alternative Fuels') }}</option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="form-group col-4">
                            ...
                            <input type="text" name="in_houre" value="{{ old('in_houre') ?? $car_pricing->in_houre }}"
                                   id="in_houre"
                                   class="form-control @error('in_houre') is-invalid alert-danger @enderror"/></div>
                        <div class="form-group col-4">
                            <label for="in_day">{{__('in the day')}}</label>
                            <input type="text" name="in_day" value="{{ old('in_day') ?? $car_pricing->in_day }}"
                                   id="in_day" class="form-control @error('in_day') is-invalid alert-danger @enderror"/>
                        </div>
                        <div class="form-group col-4">
                            <label for="in_month">{{__('in the month')}}</label>
                            <input type="text" name="in_month" value="{{ old('in_month') ?? $car_pricing->in_month }}"
                                   id="in_month"
                    ...
                    <div class="row">
                        <div class="form-group col-3">
                            ...
                            <select id="air_conditions" name="air_conditions"
                                ...
                                <option
                                    value="1" {{ $car_features->air_conditions == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        <div class="form-group col-3">
                            ...
                            <select id="child_seat" name="child_seat"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->child_seat == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        <div class="form-group col-3">
                            ...
                            <select id="gps" name="gps"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->gps == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="luggage" name="luggage"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->luggage == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="music" name="music"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->music == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="seat_beit" name="seat_beit"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->seat_beit == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="sleeping_bed" name="sleeping_bed"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->sleeping_bed == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="water" name="water"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->water == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="bluetooth" name="bluetooth"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->bluetooth == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="onboard_computer" name="onboard_computer"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->onboard_computer == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="audio_input" name="audio_input"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->audio_input == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="long_term_trips" name="long_term_trips"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->long_term_trips == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="car_kit" name="car_kit"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->car_kit == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select id="remote_central_locking" name="remote_central_locking"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->remote_central_locking == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-6">
                            ...
                            <select id="climate_control" name="climate_control"
                                ...
                                <option value="0">{{ __('false') }}</option>
                                <option
                                    value="1" {{ $car_features->climate_control == '1'  ? 'selected':'' }}>{{ __('true') }}</option>
                            </select>
                        </div>
                        <br/>
                    </div>
