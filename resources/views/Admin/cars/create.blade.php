            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="row">
                    <div class="form-group col-4">
                        ...
                        <input type="text" name="in_houre" value="{{ old('in_houre') }}" id="in_houre" class="form-control @error('in_houre') is-invalid alert-danger @enderror" /> </div>
                    <div class="form-group col-4">
                        <label for="in_day">{{__('in the day')}}</label>
                        <input type="text" name="in_day" value="{{ old('in_day') }}" id="in_day" class="form-control @error('in_day') is-invalid alert-danger @enderror" /> </div>
                    <div class="form-group col-4">
                        <label for="in_month">{{__('in the month')}}</label>
                        <input type="text" name="in_month" value="{{ old('in_month') }}" id="in_month" class="form-control @error('in_month') is-invalid alert-danger @enderror" /> </div>
                </div>
            </div>
            <br />
