    ...
    <div class="card-body">
        <div class="table-responsive pt-3">
            <table class="table table-bordered">
                ...
                <tbody>
                    @foreach ($rents as $key => $rc)
                    <tr class="">
                        <td>{{ $rc->rent->user->name }}</td>
                        <td>{{ $rc->car->name }}</td>
                        <td>{{ $rc->rent->location }}</td>
                        <td>{{ $rc->rent->drop_off_location }}</td>
                        <td>{{ $rc->rent->pik_up_date }}</td>
                        <td>{{ $rc->rent->drop_off_date }}</td>
                        <td>{{ $rc->rent->pik_up_time }}</td>
