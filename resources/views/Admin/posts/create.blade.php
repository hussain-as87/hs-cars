    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                    ...
                    <div class="form-group mb-0 row">
                        ...
                        <div class="col-lg-8">
                            <textarea id="description" name="description"
                                      ...
                                      placeholder="{{__('This textarea has a limit of 500 chars.')}}"></textarea>
            ...
            <div class="modal-footer">
                <button class="btn btn-outline-primary"><i data-feather="plus"
                                                           class="icon-sm mr-2"></i> {{__('create')}}</button>
            </div>
            </form>
