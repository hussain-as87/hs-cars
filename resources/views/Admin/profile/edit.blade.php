...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form novalidate="novalidate" class="cmxform" id="signupForm" method="POST"
                ...
                <fieldset>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="avatar"
                                           class="file-upload-default @error('avatar') is-invalid alert-danger @enderror">
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label class="form-control-label"
                                           for="input-city">{{__('background image')}}</label>
                                    <input type="file" name="background_image"
                                           class="file-upload-default @error('background_image') is-invalid alert-danger @enderror">
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled=""
                                               placeholder="{{ __('Upload image') }}">
                                        <span class="input-group-append">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="input-first-name" name="f_name"
                                           class="form-control @error('fname') border-danger @enderror"
                                           placeholder="{{ $user->profile->f_name }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="input-last-name" name="l_name"
                                           class="form-control @error('lname') border-danger @enderror"
                                           placeholder="{{ $user->profile->l_name }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="example-date-input"
                                           class="form-control-label">{{__('date_of_birth')}}</label>
                                    <input
                                        class="form-control bg-gradient-secondary @error('date_of_birth') border-danger @enderror"
                                        name="date_of_birth" type="date" value="{{ $user->profile->date_of_birth }}"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="city" id="input-city"
                                           ...
                                           placeholder="{{ $user->profile->city }}" value="{{ $user->profile->city }}">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="country" id="input-country"
                                           ...
                                           placeholder="{{old('country')?'': $user->profile->country }}"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="postal_code" id="input-postal-code"
                                           ...
                                           placeholder="{{old('postal_code')?'': $user->profile->postal_code }}"
                    ...
                    <div class="pl-lg-4">
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="about_me"
                                      class="form-control @error('about_me') border-danger @enderror"
                                      placeholder="{{old('about_me')?'': $user->profile->about_me }}">{{ $user->profile->about_me }}</textarea>
                            @error('about_me') <span class="text-danger">{{ $message }}</span> @enderror </div>
                    </div>
                    <div class="pl-lg-4">
                        <button class="btn btn-outline-primary " type="submit">{{ __('edit') }} <i data-feather="edit"
