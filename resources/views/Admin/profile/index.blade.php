                        ...
                        <div class="profile-header">
                            <div class="cover" wire:poll>
                                ...
                                <figure>
                                    ...
                                    https://via.placeholder.com/1148x272 @endif" class="img-fluid" alt="profile cover"
                                         style="height: 250px">
                                </figure>

                                <div class="cover-body d-flex justify-content-between align-items-center">
                                    <div>
                                        <button class="nobu" onclick="showSwal('custom-html')"><img class="profile-pic"
                                                                                                    src="@if(auth()->user()->profile->avatar){{asset('storage/users/avatar/'.auth()->user()->profile->avatar)}}
                                                                                            @else https://ui-avatars.com/api/?name={{ auth()->user()->name }}@endif"
                                                                                                    alt="profile">
                                        </button>
                                    ...
                                    <div class="d-none d-md-block">
                                        <a href="{{route('profile.edit')}}"
                                           class="btn btn-secondary btn-icon-text btn-edit-profile">
                                            <i data-feather="edit-3"
                                               class="btn-icon-prepend"></i> {{__('edit profile')}}
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="header-links">
                                <ul class="links d-flex align-items-center mt-3 mt-md-0">
                                    ...
                                    <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                                        ...
                                        <a class="pt-1px d-none d-md-block" href="#">{{__('friends')}} <span
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item d-flex align-items-center" href="#"><i
                                                    data-feather="edit-2" class="icon-sm mr-2"></i>
                                                <span class="">Edit</span></a>
                                            <a class="dropdown-item d-flex align-items-center" href="#"><i
                                                    data-feather="git-branch" class="icon-sm mr-2"></i> <span class="">Update</span></a>
                                            <a class="dropdown-item d-flex align-items-center" href="#"><i
                                                    data-feather="eye" class="icon-sm mr-2"></i>
                            ...
                            <div class="col-md-12 py-4">
                                <div class="card rounded">
                                    <button type="button" class="btn btn-secondary" data-toggle="modal"
                                            data-target="#createModal">{{ __('create new post') }} <i
                                            data-feather="feather" class="icon-sm mr-2"></i></button>
                                </div>
                            </div>
                                    ...
                                    <div class="card rounded">
                                        <div class="card-header">
                                            <div class="d-flex align-items-center justify-content-between">
                                             ...
                                             @else https://ui-avatars.com/api/?name={{ $post->user->name }}@endif"
                                                         alt="">
                                                    <div class="ml-2">
                                                        <p>{{$post->user->name}}</p>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                        ...
                                                        <a class="dropdown-item d-flex align-items-center" href="#"><i
                                                                data-feather="corner-right-up" class="icon-sm mr-2"></i>
                                                        ...
                                                        <button class="nobu w-100" data-toggle="modal"
                                                                data-target="#updateModal">
                                                            <a class="dropdown-item d-flex align-items-center" href="#"><i
                                                                    data-feather="edit-2" class="icon-sm mr-2"></i>
                                                                <span class="">{{ __('edit') }}</span></a>
                                                        </button>
                                                        <form action="{{ route('posts.destroy',$post->id) }}"
                                                              method="POST">
                                                            @method('DELETE')
                                                            @csrf
                                                            <button class="nobu w-100"
                                                                    onclick="return confirm('Are you sure?')"
                                                                    type="submit">
                                                                <a class="dropdown-item d-flex align-items-center"
                                                                   href="#"><i data-feather="trash"
                                                                               class="icon-sm mr-2"></i> <span
                                                                        class="">{{ __('delete') }}</span></a>
                                                            </button>
                                                        </form>
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if($post->photo != null)
                                                <img class="img-fluid"
                                                     src="{{asset('storage/post/photos/'.$post->photo)}}" alt="">
                                            @endif
                                            @if($post->video != null)
                                                <video class="video-fluid z-depth-1" autoplay loop controls muted>
                                                    <source src="{{ asset('storage/post/videos/'.$post->video) }}"
                                                            type="video/mp4"/>
                                                </video>
                                            @endif
                                        </div>
                                                ...
                                                @foreach($posts as $key => $post)
                                                    @if($post->photo != null)
                                                        <div class="col-md-4">
                                                            <figure>
                                                                <img class="img-fluid"
                                                                     src="{{ asset('storage/posts/photos/'.$post->photo) }}"
                                                                     width="67" height="67" alt="">
                                                            </figure>
                                                        </div>
                                                    @endif
                                                @endforeach
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                                            ...
                                            <button class="btn btn-icon"><i data-feather="user-plus"
                                                                            data-toggle="tooltip" title="Connect"></i>
                                            </button>
                                        </div>
                                        <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                                            <div class="d-flex align-items-center hover-pointer">
