...
@section('content')
    <div class="card ">
        <div class="card-body">
            ...
            <a class="btn btn-info" href="{{ route('settings.index') }}"> {{__ ('Go Back') }} <i
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="value" id="" placeholder="{{ __('value') }}"
                                   class="form-control @error('value') is-invalid alert-danger @enderror"
                                   value="{{ $setting->value }}">
                        </div>
                    </div>
