...
<div class="tab-content" id="myTabContent">
        ...
        <div id="home{{$key}}" class="container tab-pane {{ $loop->index == 0 ? 'show active' : '' }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="name[{{$key}}]"
                       ...
                       value="{!! old('name.'.$key,$service->getTranslation('name',$key)) ?? $service->name !!}"
    ...
    <div class="form-group">
        ...
        <div class="form-check">
            <input class="form-check-input @error('logo') is-invalid alert-danger @enderror" type="radio" name="logo"
                   id="exampleRadios1"
                   value="flaticon-wedding-car" {{ $service->logo == 'flaticon-wedding-car' ? 'checked' : '' }}>
        ...
        <div class="form-check">
            <input class="form-check-input @error('logo') is-invalid alert-danger @enderror" type="radio" name="logo"
                   id="exampleRadios2" value="flaticon-car" {{ $service->logo == 'flaticon-car' ? 'checked' : '' }}>
        ...
        <div class="form-check">
            <input class="form-check-input @error('logo') is-invalid alert-danger @enderror" type="radio" name="logo"
                   id="exampleRadios3"
                   value="flaticon-transportation" {{ $service->logo == 'flaticon-transportation' ? 'checked' : '' }}>
